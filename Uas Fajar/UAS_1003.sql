...
--
-- Host: localhost    Database: UAS_1003
-- ------------------------------------------------------
...
CREATE TABLE `listrik` (
  ...
  `bulan_lalu` int(11) DEFAULT NULL,
  `bulan_ini` int(11) DEFAULT NULL,
...
INSERT INTO `listrik` VALUES (1,'123456','Fajar Kurnia Putra',1200,2000,4000,'2023-06-15'),(2,'121212','Alif',4000,1000,10000,'2023-06-30');
...
-- Dump completed on 2023-06-15 16:21:39
